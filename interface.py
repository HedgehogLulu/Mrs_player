...
class Ui_MusicMrsMia(object):
    def setupUi(self, MusicMrsMia):
        ...
        self.label_internet.setPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/6.png"))
        ...
        self.label_wifi.setPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/5.png"))
        ...
        self.label_back.setPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/1.png"))
        ...
        self.label_home.setPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/2.png"))
        ...
        self.label_wt.setPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/3.png"))
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/13.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        self.prev.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/9.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        self.play.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/11.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        self.next.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/10.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/12.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        self.search.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../pythonProject1.0/иконки для телефона/7.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("иконки для телефона/sound.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
